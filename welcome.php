    ...
    <div class="collapse navbar-collapse animated fadeIn" id="bs-example-navbar-collapse-2">
      ...
      <ul id="login-dp" class="dropdown-menu">
        ...
        $result20 = $db->prepare("SELECT * FROM product");
          ...
          <h3><span>Add Book</span></h3>
          
          </figcaption>
                  <a style="color:Black;" data-toggle="modal" data-target="#my49"></a>
                      <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="my49" class="modal fade">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                <div class="modal-header">
                                <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
                            ...
                            <input class="form-control " name="book" value="" type="text" placeholder="Book Name">
